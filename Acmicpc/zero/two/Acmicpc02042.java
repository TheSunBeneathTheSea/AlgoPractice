...
public class Acmicpc02042 {
  ...
  public static void setLeafNode(int idx, long val) {
    ...
    long change = segTree[curIdx] - val;
    segTree[curIdx] = val;

    while (curIdx > 1) {
      segTree[curIdx / 2] -= change;

      curIdx /= 2;
    }
  }

  public static long getPrefixSum(int startIdx, int endIdx) {
    long result = 0;
